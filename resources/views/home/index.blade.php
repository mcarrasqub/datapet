        ...
        @foreach($viewData['pets'] as $pet)
          <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
              {{-- Image on top --}}
              @if($pet->getPhoto())
                <img src="{{ asset('storage/' . $pet->getPhoto()) }}" class="card-img-top" alt="{{ $pet->getName() }}"
              ...
              <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-1">
                  ...
                  <span class="badge"
                    style="background-color: #65a34e; font-size: 0.75rem; padding: 0.4em 0.8em; border-radius: 6px;">Vacunas
                    al día</span>
                </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex align-items-start">
                      ...
                      <div>
                        ...
                        <span class="fw-bold"
                          style="color: #1e293b;">{{ $pet->getWeight() ? $pet->getWeight() . ' kg' : 'N/D' }}</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                ...
                <div class="d-flex gap-2">
                  <a href="{{ route('pets.show', $pet->getId()) }}"
                    class="btn w-100 text-white fw-bold d-flex align-items-center justify-content-center"
                    style="background-color: #65a34e; border-radius: 8px; padding: 10px;">
                    <i class="bi bi-activity me-2"></i> Ver Detalles Completos
                  </a>
                  <a href="{{ route('pets.exams', ['pet_id' => $pet->getId()]) }}"
                    class="btn btn-outline-pet-green d-flex align-items-center justify-content-center"
                    style="border-radius: 8px; padding: 10px;" title="Exámenes">
                    <i class="bi bi-journal-medical"></i>
                  </a>

                  {{-- Maintain edit and delete functionalities as small buttons next to details --}}
                  <a href="{{ route('pets.exams') }}"
                    class="btn btn-outline-secondary d-flex align-items-center justify-content-center"
                    style="border-radius: 8px; padding: 10px;" title="Ir a Exámenes">

                                ...
                                <div class="col-md-10">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span
                                                class="fw-medium text-dark">{{ $selectedPet->getReproductiveStatus() ?? 'N/A' }}</span>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span
                                                class="fw-medium text-dark">{{ $selectedPet->getEmotionalSupport() ? 'Sí' : 'No' }}</span>
                                        </div>
                                        <div class="col-md-4">
                                            <small class="text-muted d-block mb-1 fs-75">Animal de servicio:</small>
                                            <span
                                                class="fw-medium text-dark">{{ $selectedPet->getServiceAnimal() ? 'Sí' : 'No' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow rounded-4">
                        <div class="card-body p-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="border rounded-4 p-4 h-100 bg-light">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <span
                                                    class="badge bg-pet-green rounded-pill">{{ count($medicalRecords) }}</span>
                                            </div>
                                            @forelse($medicalRecords as $record)
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <div class="fw-semibold text-dark">{{ $record->visited_at->format('Y-m-d') }}
                                                    </div>
                                                    <div class="text-secondary fs-90">{{ $record->reason }}</div>
                                                    <div class="text-secondary fs-90">
                                                        {{ $record->getDiagnosis() ?? 'Sin diagnóstico' }}</div>
                                                </div>
                                            @empty
                                        ...
                                        <div class="border rounded-4 p-4 h-100 bg-light">
                                            ...
                                            @forelse($vaccinations as $vaccination)
                                                <div class="mb-3 pb-3 border-bottom">
                                                    ...
                                                    <div class="text-secondary fs-90">Aplicada:
                                                        {{ $vaccination->vaccinated_at->format('Y-m-d') }}</div>
                                                    <div class="text-secondary fs-90">Siguiente dosis:
                                                        {{ $vaccination->next_due_date ? $vaccination->next_due_date->format('Y-m-d') : 'No programada' }}
                                                    </div>
                                                </div>
                                            @empty
                                    ...
                                    <div class="col-lg-4">
                                        <div class="border rounded-4 p-4 h-100 bg-light">
                                            ...
                                            @forelse($medicalExams as $exam)
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <div class="fw-semibold text-dark">{{ $exam->title ?? $exam->original_name }}
                                                    </div>
                                                    <div class="text-secondary fs-90">{{ $exam->category ?? 'Sin categoría' }}</div>
                                                    <div class="text-secondary fs-90">
                                                        {{ $exam->uploaded_at ? $exam->uploaded_at->format('Y-m-d') : 'N/A' }}</div>
                                                </div>
                                            @empty
                                    ...
                                    @forelse($medicalRecords as $record)
                                        <div class="border rounded-4 p-4 position-relative border-start-pet-green-dark">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="text-secondary fs-85">{{ $record->getObservation() ?? 'Ninguna' }}</span>
                                            </div>

                                            <div class="mt-4 pt-3 border-top">
                                                <form action="{{ route('clinical_observations.store', $record) }}" method="POST"
                                                    class="mb-3">
                                                    @csrf
                                                    <label for="observation-{{ $record->getId() }}"
                                                        class="form-label fw-medium fs-85 mb-2">Nueva observación</label>
                                                    <textarea id="observation-{{ $record->getId() }}" name="observation" rows="3"
                                                        ...
                                                        placeholder="Escribe un hallazgo, evolución o conducta clínica"
                                                        required></textarea>
                                                    @error('observation')<div class="invalid-feedback d-block">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <span
                                                        class="badge bg-light text-secondary border">{{ count($record->observations) }}</span>
                                                </div>
                                                ...
                                                @forelse($record->observations->sortByDesc('created_at') as $observation)
                                                    <div class="bg-light rounded-4 p-3 mb-2 border">
                                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                                            <small
                                                                class="text-muted fw-medium">{{ $observation->created_at?->format('Y-m-d H:i') }}</small>
                                                            <small class="text-muted">Dr(a). {{ $observation->doctor?->getName() }}
                                                                {{ $observation->doctor?->getLastname() }}</small>
                                                        </div>
                                                        <div class="text-secondary fs-85">{{ $observation->getObservation() }}</div>
                                                        <div class="d-flex justify-content-end gap-2 mt-2">
                                                            <a href="{{ route('clinical_observations.edit', $observation) }}"
                                                                class="btn btn-outline-secondary btn-sm"><i
                                                                    class="bi bi-pencil me-1"></i>Editar</a>
                                                            <form action="{{ route('clinical_observations.destroy', $observation) }}"
                                                                method="POST" onsubmit="return confirm('¿Eliminar esta observación?')">
                                                                @csrf
                                                                @method('DELETE')
                                                ...
                                                @empty
                                                    <div class="text-muted fs-85">No hay observaciones clínicas registradas para esta
                                                        consulta.</div>
                                                @endforelse
                                            </div>
                            ...
                            <div id="kardex" class="js-pet-section d-none">
                                ...
                                <div class="card border-0 bg-light rounded-4 p-4 mb-4">
                                    ...
                                    <form action="{{ route('kardex.store', $selectedPet) }}" method="POST" id="kardex_form">
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                <label for="kardex_entry_date"
                                                    class="form-label fw-semibold text-secondary">Fecha del Registro</label>
                                                <input type="date" name="entry_date" id="kardex_entry_date"
                                                    class="form-control rounded-3" value="{{ now()->toDateString() }}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="kardex_animal_type"
                                                    class="form-label fw-semibold text-secondary">Tipo de Animal Exótico</label>
                                                <select name="animal_type" id="kardex_animal_type" class="form-select rounded-3"
                                                    required>
                                        ...
                                        <div id="kardex_fields_wrapper" class="border rounded-4 p-3 bg-white mb-3 d-none">
                                            <h6 class="fw-bold text-pet-green mb-3 fs-90"><i
                                                    class="bi bi-activity me-1"></i>Parámetros Clínicos Específicos</h6>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="submit"
                                                class="btn btn-pet-green text-white px-4 py-2 fw-semibold rounded-3 shadow-sm"
                                                id="kardex_submit_btn" disabled>
                                ...
                                <!-- Listado histórico -->
                                <div class="d-flex flex-column gap-3">
                                    <h6 class="fw-bold text-dark mb-1 mt-2"><i class="bi bi-clock-history me-2"></i>Historial de
                                        Registros de Kardex</h6>
                                    @forelse($kardexEntries as $entry)
                                        <div class="border rounded-4 p-4 bg-light position-relative border-start-pet-green-dark">
                                            <div class="position-absolute top-0 end-0 p-3 d-flex gap-2 align-items-center">
                                                <span
                                                    class="badge bg-pet-green-dark text-white rounded-pill px-3 py-1 fs-75 text-uppercase">
                                                ...
                                                <form action="{{ route('kardex.destroy', $entry) }}" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit" class="btn btn-link text-danger p-0 border-0"
                                                        onclick="return confirm('¿Seguro que deseas eliminar esta entrada del Kardex?')">
                                            ...
                                            <div class="mb-3">
                                                <div class="fw-bold text-dark fs-105 mb-1">
                                                    <i
                                                        class="bi bi-calendar-check text-pet-green-dark me-2"></i>{{ $entry->entry_date->format('Y-m-d') }}
                                                </div>
                                                <small class="text-muted">Registrado por: Dr(a). {{ $entry->doctor->name }}
                                                    {{ $entry->doctor->lastname }}</small>
                                            </div>
                                                ...
                                                @foreach($entry->parameters as $key => $value)
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="p-2 border-bottom">
                                                            <small
                                                                class="text-muted d-block fs-75 text-capitalize">{{ str_replace('_', ' ', $key) }}:</small>
                                                            <span class="fw-semibold text-dark fs-90">
                                                                ...
                                                                @elseif(in_array($key, ['temperatura', 'temperatura_cloacal', 'temperatura_terrario']))
                                                                    °C
                            ...
                            <div id="vacunas" class="js-pet-section d-none">
                                ...
                                <form action="{{ route('vaccinations.store', $selectedPet) }}" method="POST"
                                    class="row g-3 mb-4">
                                    @csrf
                                    <div class="col-md-5">
                                        <label for="vaccine_type" class="form-label">Tipo de vacuna</label>
                                        <input type="text" name="vaccine_type" id="vaccine_type"
                                            value="{{ old('vaccine_type') }}"
                                            class="form-control @error('vaccine_type') is-invalid @enderror"
                                            placeholder="Ej: Antirrábica" required>
                                        @error('vaccine_type')<div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        <label for="vaccinated_at" class="form-label">Fecha de aplicación</label>
                                        <input type="date" name="vaccinated_at" id="vaccinated_at"
                                            value="{{ old('vaccinated_at') }}"
                                            class="form-control @error('vaccinated_at') is-invalid @enderror" required>
                                        @error('vaccinated_at')<div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        @error('next_due_date')<div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-12 text-end">
                                        <button type="submit" class="btn btn-pet-green text-white px-4">Registrar
                                            vacuna</button>
                                    </div>
                                </form>
                                ...
                                <div class="d-flex flex-column gap-3 mb-4">
                                        ...
                                        <div class="border rounded-4 p-4 bg-light">
                                            <div class="d-flex justify-content-between align-items-start gap-3">
                                                <div>
                                                    ...
                                                    <div class="text-secondary fs-90">Registrada por: Dr(a).
                                                        {{ optional($vaccination->doctor)->name }}
                                                        {{ optional($vaccination->doctor)->lastname }}</div>
                                                </div>
                                                <div class="d-flex align-items-center gap-2">
                                                    @if($vaccination->notes)
                                                        <span class="badge bg-pet-green-10 text-pet-green-dark rounded-pill">Con
                                                            notas</span>
                                                    @endif
                                                    <form action="{{ route('vaccinations.destroy', $vaccination) }}" method="POST"
                                                        class="d-inline"
                                                        onsubmit="return confirm('¿Estás seguro de eliminar esta vacuna?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center"
                                                            style="width: 32px; height: 32px;" title="Eliminar Vacuna">
                                    ...
                                    @empty
                                        <div class="text-center py-4 text-muted bg-light rounded-4">No hay vacunas registradas para
                                            esta mascota.</div>
                                    @endforelse
                                </div>
                            </div>
                            ...
                            <div id="formulas" class="js-pet-section d-none">
                                ...
                                <div class="card border-0 bg-light rounded-4 p-4 mb-4">
                                    ...
                                    <form action="{{ route('formulas.store', $selectedPet) }}" method="POST" id="formula_form">
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                <label for="formula_date" class="form-label fw-semibold text-secondary">Fecha de
                                                    Emisión</label>
                                                <input type="date" name="formula_date" id="formula_date"
                                                    class="form-control rounded-3" value="{{ now()->toDateString() }}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="formula_instructions"
                                                    class="form-label fw-semibold text-secondary">Indicaciones / Recomendaciones
                                                    Generales</label>
                                                <input type="text" name="instructions" id="formula_instructions"
                                                    class="form-control rounded-3"
                                                    placeholder="Ej: Administrar con alimento, reposar...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="border rounded-4 p-3 bg-white mb-3">
                                            <div
                                                ...
                                                <h6 class="fw-bold text-pet-green mb-0 fs-90"><i
                                                        class="bi bi-list-check me-1"></i>Lista de Medicamentos</h6>
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-pet-green px-3 rounded-pill fw-semibold"
                                                    id="btn_add_medication">
                                            ...
                                            <div id="medication_rows_container" class="d-flex flex-column gap-3">
                                                ...
                                                <div class="row g-2 align-items-end medication-row">
                                                    <div class="col-md-3 col-sm-12">
                                                        <label
                                                            class="form-label small fw-semibold text-secondary mb-1">Medicamento</label>
                                                        <input type="text" name="medications[0][name]"
                                                            class="form-control rounded-3" placeholder="Ej: Meloxicam" required>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12">
                                                        <label
                                                            class="form-label small fw-semibold text-secondary mb-1">Dosis</label>
                                                        <input type="text" name="medications[0][dose]"
                                                            class="form-control rounded-3" placeholder="Ej: 0.2 ml" required>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12">
                                                        <label
                                                            class="form-label small fw-semibold text-secondary mb-1">Frecuencia</label>
                                                        <input type="text" name="medications[0][frequency]"
                                                            class="form-control rounded-3" placeholder="Ej: Cada 24 horas"
                                                            required>
                                                    </div>
                                                    <div class="col-md-2 col-sm-10">
                                                        <label
                                                            class="form-label small fw-semibold text-secondary mb-1">Duración</label>
                                                        <input type="text" name="medications[0][duration]"
                                                            class="form-control rounded-3" placeholder="Ej: 5 días" required>
                                                    </div>
                                                    <div class="col-md-1 col-sm-2 text-end">
                                                        <button type="button"
                                                            class="btn btn-outline-danger w-100 rounded-3 btn-remove-row"
                                                            disabled>
                                                            <i class="bi bi-trash"></i>
                                                        </button>
                                                    </div>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <h6 class="fw-bold text-dark mb-1 mt-2"><i class="bi bi-clock-history me-2"></i>Historial de
                                        Fórmulas Emitidas</h6>
                                    @forelse($medicalFormulas as $formula)
                                        <div class="border rounded-4 p-4 bg-light position-relative border-start-pet-green">
                                            <div class="position-absolute top-0 end-0 p-3 d-flex gap-2 align-items-center">
                                                <form action="{{ route('formulas.destroy', $formula) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-link text-danger p-0 border-0"
                                                        onclick="return confirm('¿Seguro que deseas eliminar esta fórmula médica?')">
                                                        <i class="bi bi-trash fs-110"></i>
                                                    </button>
                                                </form>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="fw-bold text-dark fs-105 mb-1">
                                                    <i
                                                        class="bi bi-calendar-check text-pet-green-dark me-2"></i>{{ $formula->formula_date->format('Y-m-d') }}
                                                </div>
                                                <small class="text-muted">Prescrito por: Dr(a). {{ $formula->doctor->name }}
                                                    {{ $formula->doctor->lastname }}</small>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        @foreach($formula->medications as $med)
                                                            <tr>
                                                                ...
                                                                <td><span
                                                                        class="badge bg-light text-dark border px-2 py-1 rounded-pill">{{ $med['dose'] ?? '' }}</span>
                                                                </td>
                                                                <td><span
                                                                        class="badge bg-light text-dark border px-2 py-1 rounded-pill">{{ $med['frequency'] ?? '' }}</span>
                                                                </td>
                                                                <td><span
                                                                        class="badge bg-light text-dark border px-2 py-1 rounded-pill">{{ $med['duration'] ?? '' }}</span>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                            ...
                                            @if($formula->instructions)
                                                <div
                                                    class="p-3 bg-white rounded-3 border-start border-start-width-3 border-pet-green text-secondary fs-90">
                                                    <strong class="d-block text-dark mb-1"><i
                                                            class="bi bi-info-circle me-1"></i>Recomendaciones Generales:</strong>
                            ...
                            <div id="ordenes" class="js-pet-section d-none">
                                ...
                                <div class="card border-0 bg-light rounded-4 p-4 mb-4">
                                    ...
                                    <form action="{{ route('orders.store', $selectedPet) }}" method="POST" id="order_form">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label for="order_date" class="form-label fw-semibold text-secondary">Fecha de
                                                    la Orden</label>
                                                <input type="date" name="order_date" id="order_date"
                                                    class="form-control rounded-3" value="{{ now()->toDateString() }}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="order_type" class="form-label fw-semibold text-secondary">Tipo de
                                                    Orden</label>
                                                <select name="order_type" id="order_type" class="form-select rounded-3"
                                                    required>
                                            ...
                                            <div class="col-md-12">
                                                <label for="order_description"
                                                    class="form-label fw-semibold text-secondary">Detalle / Instrucciones de la
                                                    Orden</label>
                                                <textarea name="description" id="order_description" rows="3"
                                                    class="form-control rounded-3"
                                                    placeholder="Ej: Realizar hemograma y perfil bioquímico completo en ayuno de 8 horas."
                                                    required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end mt-3">
                                            <button type="submit"
                                                class="btn btn-pet-green text-white px-4 py-2 rounded-pill fw-semibold shadow-sm">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    @forelse($medicalOrders as $order)
                                        <div
                                            class="card border border-light-subtle rounded-4 p-4 shadow-sm bg-white position-relative">
                                            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        <span class="fs-95 fw-bold text-dark">
                                                            @if($order->order_type === 'Laboratorio')
                                                                <span
                                                                    class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-2 rounded-pill text-xs">
                                                                    <i class="bi bi-activity me-1"></i> Laboratorio
                                                                </span>
                                                            @elseif($order->order_type === 'Imagenología')
                                                                <span
                                                                    class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25 px-3 py-2 rounded-pill text-xs">
                                                                    <i class="bi bi-image me-1"></i> Imagenología
                                                                </span>
                                                            @elseif($order->order_type === 'Cirugía / Procedimiento')
                                                                <span
                                                                    class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 px-3 py-2 rounded-pill text-xs">
                                                                    <i class="bi bi-heart-pulse me-1"></i> Cirugía / Procedimiento
                                                                </span>
                                                            @else
                                                                <span
                                                                    class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 px-3 py-2 rounded-pill text-xs">
                                                                    <i class="bi bi-file-earmark me-1"></i> Otros
                                                                </span>
                                                            @endif
                                                        </span>
                                                        <span class="text-muted small">| Solicitada por: <strong>Dr.
                                                                {{ $order->doctor?->name ?? 'Veterinario' }}</strong></span>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <form action="{{ route('orders.destroy', $order) }}" method="POST"
                                                        class="d-inline"
                                                        onsubmit="return confirm('¿Estás seguro de eliminar esta orden clínica?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                            ...
                                            <div class="d-flex align-items-center justify-content-end gap-2 border-top pt-2">
                                                <span class="text-muted small me-2"><i class="bi bi-arrow-left-right me-1"></i>
                                                    Cambiar estado:</span>
                                                <form action="{{ route('orders.updateStatus', $order) }}" method="POST"
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-xs btn-outline-warning rounded-pill px-3 py-1 fs-80 {{ $order->status === 'pending' ? 'active' : '' }}">Pendiente</button>
                                                </form>
                                                <form action="{{ route('orders.updateStatus', $order) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-xs btn-outline-success rounded-pill px-3 py-1 fs-80 {{ $order->status === 'completed' ? 'active' : '' }}">Realizada</button>
                                                </form>
                                                <form action="{{ route('orders.updateStatus', $order) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-xs btn-outline-secondary rounded-pill px-3 py-1 fs-80 {{ $order->status === 'cancelled' ? 'active' : '' }}">Cancelada</button>
                                                </form>
                                            </div>
                                        </div>
                                    @empty
                            ...
                            <div id="examenes" class="js-pet-section d-none">
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0 fs-90">Gestiona resultados clínicos y documentos adjuntos de
                                            la mascota.</p>
                                    </div>
                                    <div class="exam-counter-pill">
                                        <span class="fw-semibold me-2">Total</span>
                                        <span
                                            class="badge bg-pet-green rounded-pill px-3 py-2">{{ count($medicalExams) }}</span>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($medicalExams as $exam)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge bg-pet-green-10 text-pet-green-dark fw-semibold px-3 py-2 rounded-pill">{{ $exam->category ?? 'Sin categoría' }}</span>
                                                        </td>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="6" class="text-center py-5">
                                                            ...
                                                            <span class="text-muted">No hay exámenes cargados para esta
                                                                mascota.</span>
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            ...
                                            <div class="d-flex justify-content-between align-items-start gap-3">
                                                <div>
                                                    <div class="fw-semibold text-dark fs-110 mb-2">
                                                        <i
                                                            class="bi bi-calendar-event text-pet-green-dark me-2"></i>{{ $appointment->getDate() }}
                                                    </div>
                                                    <div class="text-dark fw-medium fs-90 mb-1">
                                                        Hora: <span
                                                            class="text-secondary fw-normal">{{ substr($appointment->getStartTime(), 0, 5) }}
                                                            - {{ substr($appointment->getEndTime(), 0, 5) }}</span>
                                                    </div>
                                                    <div class="text-dark fw-medium fs-90 mb-1">
                                                        Doctor Asignado: <span class="text-secondary fw-normal">Dr(a).
                                                            {{ $appointment->doctor->name }}
                                                            {{ $appointment->doctor->lastname }}</span>
                                                    </div>
                                                    <div class="text-dark fw-medium fs-90 mb-1">
                                                        Motivo: <span
                                                            class="text-secondary fw-normal">{{ $appointment->getReason() ?? 'No especificado' }}</span>
                                                    </div>
                                                    <div class="text-dark fw-medium fs-90">
                                                        Estado:
                                                        @if($appointment->getStatus() === 'scheduled')
                                                            <span
                                                                class="badge bg-success rounded-pill px-3 py-1 fs-75">Programada</span>
                                                        @elseif($appointment->getStatus() === 'canceled')
                                                            <span class="badge bg-danger rounded-pill px-3 py-1 fs-75">Cancelada</span>
                                                        @else
                                                            <span
                                                                class="badge bg-secondary rounded-pill px-3 py-1 fs-75">{{ ucfirst($appointment->getStatus()) }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade" id="editPetModal" tabindex="-1" aria-labelledby="editPetModalLabel"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg rounded-4">
                                <form action="{{ route('medical_records.update_pet', $selectedPet->getId()) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="modal-body p-4" style="max-height: 70vh; overflow-y: auto;">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label for="modal_name"
                                                        class="form-label small fw-semibold text-secondary">Nombre *</label>
                                                    <input type="text" name="name" id="modal_name"
                                                        value="{{ $selectedPet->getName() }}"
                                                        class="form-control rounded-3 shadow-sm border" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_species"
                                                        class="form-label small fw-semibold text-secondary">Especie *</label>
                                                    <input type="text" name="species" id="modal_species"
                                                        value="{{ $selectedPet->getSpecies() }}"
                                                        class="form-control rounded-3 shadow-sm border" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_breed"
                                                        class="form-label small fw-semibold text-secondary">Raza/Subespecie</label>
                                                    <input type="text" name="breed" id="modal_breed"
                                                        value="{{ $selectedPet->getBreed() }}"
                                                        class="form-control rounded-3 shadow-sm border">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_gender"
                                                        class="form-label small fw-semibold text-secondary">Género *</label>
                                                    <select name="gender" id="modal_gender"
                                                        class="form-select rounded-3 shadow-sm border" required>
                                                        <option value="male" @selected($selectedPet->getGender() === 'male')>Macho
                                                            (Male)</option>
                                                        <option value="female" @selected($selectedPet->getGender() === 'female')>
                                                            Hembra (Female)</option>
                                                        <option value="unknown"
                                                            @selected($selectedPet->getGender() === 'unknown')>Desconocido
                                                            (Unknown)</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_age"
                                                        class="form-label small fw-semibold text-secondary">Edad (años)</label>
                                                    <input type="number" name="age" id="modal_age"
                                                        value="{{ $selectedPet->getAge() }}" min="0" max="200"
                                                        class="form-control rounded-3 shadow-sm border">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_weight"
                                                        class="form-label small fw-semibold text-secondary">Peso
                                                        (Kilogramos)</label>
                                                    <input type="number" name="weight" id="modal_weight"
                                                        value="{{ $selectedPet->getWeight() }}" step="0.01" min="0"
                                                        class="form-control rounded-3 shadow-sm border">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_color"
                                                        class="form-label small fw-semibold text-secondary">Color</label>
                                                    <input type="text" name="color" id="modal_color"
                                                        value="{{ $selectedPet->getColor() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Sable, Gris">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_size"
                                                        class="form-label small fw-semibold text-secondary">Talla</label>
                                                    <input type="text" name="size" id="modal_size"
                                                        value="{{ $selectedPet->getSize() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Pequeña, Mediana, Grande">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_reproductive_status"
                                                        class="form-label small fw-semibold text-secondary">Estado
                                                        Reproductivo</label>
                                                    <input type="text" name="reproductive_status" id="modal_reproductive_status"
                                                        value="{{ $selectedPet->getReproductiveStatus() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Esterilizado, Entero">
                                                </div>
                                                <div class="col-12">
                                                    <label for="modal_photo"
                                                        class="form-label small fw-semibold text-secondary">Foto de la
                                                        Mascota</label>
                                                    <input type="file" name="photo" id="modal_photo"
                                                        class="form-control rounded-3 shadow-sm border" accept="image/*">
                                                    <small class="text-muted d-block mt-1">Formatos aceptados: JPG, JPEG, PNG,
                                                        WEBP. Máx: 2MB.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <label for="modal_is_deceased"
                                                        class="form-label small fw-semibold text-secondary">¿Fallecido?
                                                        *</label>
                                                    <select name="is_deceased" id="modal_is_deceased"
                                                        class="form-select rounded-3 shadow-sm border" required>
                                                ...
                                                <div class="col-md-4">
                                                    <label for="modal_emotional_support"
                                                        class="form-label small fw-semibold text-secondary">¿Apoyo Emocional?
                                                        *</label>
                                                    <select name="emotional_support" id="modal_emotional_support"
                                                        class="form-select rounded-3 shadow-sm border" required>
                                                        <option value="0" @selected(!$selectedPet->getEmotionalSupport())>No
                                                        </option>
                                                        <option value="1" @selected($selectedPet->getEmotionalSupport())>Sí
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_service_animal"
                                                        class="form-label small fw-semibold text-secondary">¿Animal de Servicio?
                                                        *</label>
                                                    <select name="service_animal" id="modal_service_animal"
                                                        class="form-select rounded-3 shadow-sm border" required>
                                                        <option value="0" @selected(!$selectedPet->getServiceAnimal())>No
                                                        </option>
                                                        <option value="1" @selected($selectedPet->getServiceAnimal())>Sí
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_last_heat"
                                                        class="form-label small fw-semibold text-secondary">Último Calor /
                                                        Celo</label>
                                                    <input type="text" name="last_heat" id="modal_last_heat"
                                                        value="{{ $selectedPet->getLastHeat() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Hace 2 meses, N/A">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <label for="modal_diet"
                                                        class="form-label small fw-semibold text-secondary">Alimento
                                                        (Dieta)</label>
                                                    <input type="text" name="diet" id="modal_diet"
                                                        value="{{ $selectedPet->getDiet() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Tenebrios y vegetales">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_diet_quantity"
                                                        class="form-label small fw-semibold text-secondary">Cantidad de
                                                        Alimento</label>
                                                    <input type="text" name="diet_quantity" id="modal_diet_quantity"
                                                        value="{{ $selectedPet->getDietQuantity() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: 50gr diarios">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="modal_diet_frequency"
                                                        class="form-label small fw-semibold text-secondary">Frecuencia de
                                                        Alimento</label>
                                                    <input type="text" name="diet_frequency" id="modal_diet_frequency"
                                                        value="{{ $selectedPet->getDietFrequency() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: 2 veces al día">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_housing"
                                                        class="form-label small fw-semibold text-secondary">Vivienda
                                                        (Jaula/Terrario)</label>
                                                    <input type="text" name="housing" id="modal_housing"
                                                        value="{{ $selectedPet->getHousing() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Terrario con manta térmica">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_bath_frequency"
                                                        class="form-label small fw-semibold text-secondary">Frecuencia de
                                                        Baño</label>
                                                    <input type="text" name="bath_frequency" id="modal_bath_frequency"
                                                        value="{{ $selectedPet->getBathFrequency() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Cada 2 meses, No requiere">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_bath_products"
                                                        class="form-label small fw-semibold text-secondary">Productos de
                                                        Baño</label>
                                                    <input type="text" name="bath_products" id="modal_bath_products"
                                                        value="{{ $selectedPet->getBathProducts() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Champú pH neutro avena">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="modal_other_pets"
                                                        class="form-label small fw-semibold text-secondary">Otras Mascotas
                                                        (¿Cuáles?)</label>
                                                    <input type="text" name="other_pets" id="modal_other_pets"
                                                        value="{{ $selectedPet->getOtherPets() }}"
                                                        class="form-control rounded-3 shadow-sm border"
                                                        placeholder="Ej: Un gato, Ninguna">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer border-0 p-3 bg-light rounded-bottom-4">
                                        <button type="button" class="btn btn-outline-secondary px-4 rounded-3 fw-medium"
